...
class RegistrationCard extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Your Registration Card - ' . $this->registration->event->title,
    ...
    public function attachments(): array
    {
        ...
        if (Storage::disk('public')->exists($qrCodePath)) {
            $attachments[] = Attachment::fromStorageDisk('public', $qrCodePath)
                ->as("registration_card_{$this->registration->registration_code}.svg")
