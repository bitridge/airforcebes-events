...
@section('title', 'Attendee Profile - ' . config('app.name'))
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('admin.attendees.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <dl class="space-y-2">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">{{ $attendee->email }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Phone</dt>
                                    <dd class="text-sm text-gray-900">{{ $attendee->phone ?? 'Not provided' }}</dd>
                                </div>
                            </dl>
                        </div>
                        <div>
                            <dl class="space-y-2">
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            @if($attendee->role === 'admin') bg-red-100 text-red-800
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">{{ $attendee->created_at->format('M d, Y') }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                ...
                <div class="px-6 py-4">
                                    ...
                                    @foreach($attendee->registrations as $registration)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-sm text-gray-500">{{ $registration->event->venue }}</div>
                                            </td>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">This attendee hasn't registered for any events yet.</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="text-center py-8">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No Communication History</h3>
                        <p class="mt-1 text-sm text-gray-500">Communication logs will appear here when messages are sent.</p>
                    </div>
                </div>
            </div>
        </div>
