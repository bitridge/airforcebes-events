        ...
        @if(($registrations->count() ?? 0) > 0)
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Your Event Registrations</h3>
                </div>
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div class="flex-1 mb-4 lg:mb-0">
                                    <div class="flex items-center space-x-3 mb-2">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $registration->status_badge_color ?? 'bg-gray-100 text-gray-800' }}">
                                            {{ $registration->status_display_name ?? ucfirst($registration->status) }}
                                        </span>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                                        <div class="flex items-center">
                                            ...
                                            {{ $registration->event->formatted_date_range ?? 'Date TBD' }}
                                        </div>
                                        <div class="flex items-center">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            {{ $registration->event->formatted_time_range ?? 'Time TBD' }}
                                        </div>
                                        <div class="flex items-center">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="mt-3 text-sm text-gray-500">
                                        ...
                                        <strong>Registered:</strong> {{ $registration->formatted_registration_date ?? $registration->created_at->format('M j, Y') }}
                                    </div>
                                </div>
