<x-app-layout>
    <x-slot name="title">{{ config('app.name') }} - Professional Development Events</x-slot>
    <x-slot name="description">Discover and register for upcoming Air Force events, workshops, and networking opportunities.</x-slot>
